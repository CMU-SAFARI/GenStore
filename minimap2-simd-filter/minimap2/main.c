...
//		fprintf(fp_help, "    -v INT       verbose level [%d]\n", mm_verbose);
    ...
    bool exact_flag = fnw; //TODO: nika; it now only generate exact match index!
	while ((mi = mm_idx_reader_read(idx_rdr, n_threads, exact_flag)) != 0) {
        printf("2: read read batch\n");
		int ret;
