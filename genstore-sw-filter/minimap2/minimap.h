...
void mm_map2(const mm_idx_t *mi, const mm_idx_t *mi_exact, int l_seq, const char *seq, int *n_regs, mm_tbuf_t *b, const mm_mapopt_t *opt, const mm_mapopt_t *opt_exact, const char *name, int SEED_NUM_PER_READ, int MATCH_NUM_PER_SEED, int MAX_NUM_MAPPING_LOCATION_PER_READ, int *MappedReadNo, int *Accepted, int *Rejected, int SSWindow, int SSIteration, int SSEditThreshold, const char * qname2, int printSAM, long *exact_cnt, long *total_cnt, int *mismatch_log, double *hash_time);

int mm_map_frag2(const mm_idx_t *mi, const mm_idx_t *mi_exact, int n_segs, const int *qlens, const char **seqs, int *n_regs, mm_tbuf_t *b, const mm_mapopt_t *opt, const mm_mapopt_t *opt_exact, const char *qname, int SEED_NUM_PER_READ, int MATCH_NUM_PER_SEED, int MAX_NUM_MAPPING_LOCATION_PER_READ, int *MappedReadNo, int *Accepted, int *Rejected, int SSWindow, int SSIteration, int SSEditThreshold, const char * qname2, int printSAM, long *exact_cnt, long *total_cnt, int *mismatch_log, double *hash_time);
